...
$(document).on("change",".change_status",function(e){
    ...
    const  notupdatedstatus = () => {
        toastr.info(`👋 Status Not Updated Still ${checked ? 'InActive' : 'Active'}!`,
    ...
    $.ajax({
        ...
        success : function(data){
            if(data.Status==200)
            {
                ...
                toastr['success']('👋 Status Successfully '+(checked?'Activated':'InActivated')+'!', (checked?'Activated!':'InActivated!'), {
                    closeButton: true,
                    tapToDismiss: false
                  });
...
$(document).on("click",".delete_record",function(e){
    ...
    const  notDeleted = () => {
        toastr.info(`👋 Record Not Deleted!`,
         'Not Deleted',
        { closeButton: true, tapToDismiss: false });
    }        
...
$(document).on("click",".itsrst-pass",function(e){
    ...
    const  notresetpass = () => {
        toastr.info(`👋 Password Not Reseted Still!`, 'Still Old Password!',
        { closeButton: true, tapToDismiss: false });
    }
    Swal.fire({
        title: 'Are you sure?',
            ...
            if (result.value) {
                ...
                $.ajax({
                    ...
                    success : function(data){
                        if(data.Status==200)
                        {
                            toastr['success']('👋 Password Reseted Successfully!', 'Password Reseted!', {
                                closeButton: true,
                                tapToDismiss: false
                            });
                        }
...
$(document).on("click",".itclrlogin",function(e){
    ...
    const  notclearedAttempts = () => {
        toastr.info(`👋 Not Cleared!`, 'Not Cleared!',
        { closeButton: true, tapToDismiss: false });
    }
    Swal.fire({
        title: 'Are you sure?',
            ...
            if (result.value) {
                ...
                $.ajax({
                    ...
                    success : function(data){
                        if(data.Status==200)
                        {
                            toastr['success']('👋Successfully cleared login Attempts!', 'Cleared Login Attempts!', {
                                closeButton: true,
                                tapToDismiss: false
                            });
                        }
