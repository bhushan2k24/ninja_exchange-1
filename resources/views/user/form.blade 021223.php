    ...
    <div class="col-12">
      <form method="post" action="{{route('store.user')}}">
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="mb-1 col-12 col-md-3">
                ...
                <input type="name" id="name" placeholder="name" class="form-control" name="name">
              </div>
              ...
              <div class="mb-1 col-12 col-md-3">
                ...
                <input type="number" id="mobile" placeholder="Mobile" class="form-control" name="mobile">
              </div>
              <div class="mb-1 col-12 col-md-3">
        ...
        <!--  User Hidden Block Account details-->
          <div class="card add-section  hidden user_section">
          <div class="card-header">
                ...
                <div class="invoice-terms mt-1">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="form-check form-switch">
                            <input type="checkbox" value='1' class="form-check-input" name="order_outside_of_high_low" id="order_outside_of_high_low" />
                            <label class="form-check-label" for="order_outside_of_high_low"></label>
                        </div>
                    </div>
                    <div class="d-flex justify-content-between py-1">
                        <label class="invoice-terms-title mb-0" for="apply_auto_square">Apply Auto Square</label>
                        <div class="form-check form-switch">
                            <input type="checkbox" value='1' class="form-check-input" name="apply_auto_square" id="apply_auto_square" />
                    ...
                    <div class="d-flex justify-content-between ">
                        ...
                        <div class="form-check form-switch">
                            <input type="checkbox" value='1' class="form-check-input" name="intra_day_auto_square" id="intra_day_auto_square" />
                    ...
                    <div class="d-flex justify-content-between py-1">
                      ...
                      <div class="form-check form-switch">
                          <input type="checkbox" value='1' class="form-check-input" name="only_position_squareoff" id="only_position_squareoff" />
                    ...
                    <div class="d-flex justify-content-between ">
                      ...
                      <div class="form-check form-switch">
                          <input type="checkbox" value='1' class="form-check-input" name="mtm_linked_with_ledger" id="mtm_linked_with_ledger" />
            ...
            <div class="mb-1 col-12 col-md-8 row">
              ...
              <div class="mb-1 col-12 col-md-6">
                  ...
                  <select name="user_account_type_id" class="form-control form-select ">
                    ...
                    <option value="{{$val->id}}">{{strtoupper(str_replace('-', ' ', $val->level_name))}}</option>
                    @endforeach;
                  </select>
              ...
              <div class="mb-1 col-12 col-md-6">
                  ...
                  <input type="number" placeholder="Margin Limit" class="form-control" name="margin_limit" id="margin_limit">
              </div>
              <div class="mb-1 col-12 col-md-6">
                <label class="form-label">Loss Alert Percentage</label>                  
                <input type="number" placeholder="Loss Alert Percentage" class="form-control" name="loss_alert_percentage" id="loss_alert_percentage">
              </div>
              <div class="mb-1 col-12 col-md-6">
                <label class="form-label">Loss Alert Margin</label>                  
                <input type="number" placeholder="Loss Alert Margin" class="form-control" name="loss_alert_margin" id="loss_alert_margin">
              </div>
            </div>
            </div>
          </div>
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="mb-1 col-12 col-md-6">
                ...
                <input type="number" placeholder="Master Creation Limit" class="form-control" name="master_creation_limit" id="master_creation_limit">
              </div>
                ...
                <div class="row from-group">
                    ...
                    foreach($accountTypeData as $key => $val)
                    {
                      ...
                      '<div class="text-capitalize form-check form-check-primary  form-check-inline mt-1">
                        <input type="checkbox" name="master_account_type_ids" '.($key<=5 ? 'checked' : '').' value="'.$val->id.'" class="form-check-input" id="account_type'.$key.'">
                        ...
                        echo '<div class="collapse " id="collapse_'.$key.'">
                            <div class="d-flex p-1 border row">';
                              ...
                              echo '<div class="col-md-3 col mb-1">
                                      <label class="form-label">Min Lot Wise Brokerage</label>     
                                          <div class="input-group input-width-drop-down">
                                              <input type="number" class="form-control" name="market_type['.$value['id'].'][lot_wise_brokerage]" placeholder="Min Lot Wise Brokerage" disabled>
                                              <select disabled name="market_type['.$value['id'].'][lot_wise_brokerage_is_percentage]" class="form-select waves-effect">
                                                <option value=\'1\'>%</option>
                                                <option value=\'0\'>₹</option>
                                              </select>
                                          </div>
                              ...
                              echo '<div class="col-md-3 col mb-1">
                                      <label class="form-label">Min Amount Wise Brokerage(100000)</label>     
                                          <div class="input-group input-width-drop-down">
                                              <input type="number" class="form-control" name="market_type['.$value['id'].'][amount_wise_brokerage]" placeholder="Min Amount Wise Brokerage(100000)" disabled>
                                              <select disabled name="market_type['.$value['id'].'][amount_wise_brokerage_is_percentage]" class="form-select waves-effect">
                                                <option value=\'1\'>%</option>
                                                <option value=\'0\'>₹</option>
                                              </select>
                                          </div>
